...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gray-900 relative overflow-hidden" onMouseMove={handleMouseMove}>
      {/* Background Effects */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-10 w-72 h-72 bg-xaloc-orange rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="text-lg font-semibold max-w-6xl mx-auto px-4 leading-relaxed break-words">
            {(() => {
              let wordCounter = 0;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-2xl font-black text-white mb-4">Why Choose Xaloc?</h3>
          ...
          {stats.map((stat, index) => (
            <div key={index} className="text-center group">
              <div className="glass-dark p-6 rounded-xl group-hover:bg-xaloc-orange/10 transition-all duration-300">
                <stat.icon className="w-8 h-8 text-xaloc-orange mx-auto mb-4" />
