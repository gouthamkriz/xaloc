...
const Navigation = ({ mobile = false, onItemClick }) => {
  ...
  const navItems = [
    ...
    { id: 'about', label: 'About', to: '/about' },
    {
      ...
      to: '/services',
      dropdown: [
        { label: 'Website Design & Development', to: '/services/1' },
        { label: 'META Ads Management', to: '/services/2' },
        { label: 'Google Ads Campaigns', to: '/services/3' },
        { label: 'SEO & Website Indexing', to: '/services/4' },
        { label: 'GMB Management', to: '/services/5' },
